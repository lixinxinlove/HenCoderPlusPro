package com.lixinxinlove.hencoderpluspro.utils;
...
public class Utils {
    ...
    public static Bitmap getAvatar(Resources res, int width) {
        ...
        BitmapFactory.decodeResource(res, R.mipmap.meinu, options);
        options.inJustDecodeBounds = false;
        options.inDensity = options.outWidth;
        options.inTargetDensity = width;
        return BitmapFactory.decodeResource(res,  R.mipmap.meinu, options);
    }
